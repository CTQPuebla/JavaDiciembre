...
public class Ejercicio16 {
	public static void main(String[] args) {
	    ...
	    System.out.println("Digite el numero de la zona correspondiente de siguiente lista: ");
	    ...
	    zona = s.nextInt();
	    System.out.println("Digite el peso del paquete en kilogramos: ");
	    peso = s.nextInt();
	    
	    if (peso > 5){
	      System.out.println("El paquete no puede ser transportado por motivos de seguridad.");
	    } else if (peso < 1) {
